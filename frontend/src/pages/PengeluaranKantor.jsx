...
import { getPengeluaran, postPengeluaran } from '../services/api';
...
export default function PengeluaranKantor() {
  ...
  const load = async (p = page) => {
    try {
      setLoading(true);
      const res = await getPengeluaran({ page: p, limit });
      const body = res.data;
  ...
  return (
    <div>
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Tambah Pengeluaran Kantor">
